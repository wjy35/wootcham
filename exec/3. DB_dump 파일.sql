...
insert into topic_type_detail (type, name, sub_keyword)
values
(0, '비공개', 0),(1, '삼행시', 1),(2, '이름 짓기', 1),(3, '아재 개그', 0),(4, '슬랩스틱', 0),(5, '성대모사', 0),(6, '자유', 0);

-- topic type DB dump 파일
insert into topic (type, keyword)
values	
(1, "노트북"), (1, "디지털"), (1, "물고기"), (1, "별자리"), (1, "빗소리"),
(1, "오징어"), (1, "홍길동"), (1, "냉장고"), (1, "콩나물"), (1, "자전거"),
(1, "삼겹살"), (1, "이어폰"), (1, "핸드폰"), (1, "컴퓨터"), (1, "감자탕"),
(1, "삼계탕"), (1, "노래방"), (1, "쓰레기"), (1, "지하철"), (1, "김치찜"),
(1, "라이벌"), (1, "비속어"), (1, "자연인"), (1, "무지개"), (1, "유자차"),
(1, "전남친"), (1, "전여친"), (1, "마스크"), (1, "아버지"), (1, "카메라"), 
(2, "노씨 자식"), (2, "방씨 자식"), (2, "설씨 자식"), (2, "유씨 애인"), (2, "옥씨 애인"),
(2, "정씨 자식"), (2, "차씨 자식"), (2, "문씨 자식"), (2, "박씨 자식"), (2, "홍씨 자식"),
(2, "J 영어이름"), (2, "Y 영어이름"), (2, "R 영어이름"), (2, "S 영어이름"), (2, "D 영어이름"),  
